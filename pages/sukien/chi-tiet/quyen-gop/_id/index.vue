<template>
    <div class="w-[1032px] mx-auto flex flex-col">
        ...
        <div>
            <span class="text-[48px] text-[#252733] font-bold">Quỹ khuyến học dòng họ Lê</span>
        </div>
        <div class="flex flex-row justify-between">
            <div class="w-[599px]">
                <span class="text-[16px] text-[#252733]">Nhằm mục đích tạo điều kiện cho con, em, cháu trong dòng họ có được điều kiện học tập tốt nhất!</span>
            </div>
            <div class="flex flex-row justify-between">
                <button :class="{active: isActive}" class=" rounded-[4px] border text-[#fff] bg-[#BF1014] font-bold text-[16px] w-[328px] h-[40px]" @click="dongGop()">
                    {{ button }}
                </button>
            </div>
        </div>
        <div class="h-[700px] flex flex-row justify-between mb-[30px] mt-6">
            <div class="bg-white p-6 mr-4 flex flex-col w-[680px] rounded-[4px]">
                <div class="flex flex-row justify-between">
                    <span class="ttext-[#252733] text-[16px] font-bold">Tổng quỹ hiện tại:</span>
                    <button class="text-[#369FFF] text-[14px]">
                        Xem chi tiết
                    </button>
                </div>
                <div class="mt-3 mb-6">
                    <span class="text-[24px] text-[#BF1014] font-bold">1.800.000 đ</span>
                </div>
